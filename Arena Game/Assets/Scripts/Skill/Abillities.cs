...
public class Abillities : MonoBehaviour
{
    ...
    public void SpawnSkill()
    {
        ...
        if (!Spell.IsBuff)
        {
            ...
            else if (Spell.PlayergroundVFX != null || Spell.MaxRangeVFX !=null)
            {
